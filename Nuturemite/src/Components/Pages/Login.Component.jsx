    ...
    <Navbar />
      <section >
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen sm:h-screen lg:py-0 mt-[100px]">
          <div class="login w-full bg-white  rounded-lg shadow dark:border md:mt-0 sm:mx-auto sm:w-full sm:max-w-md xl:p-0 dark:bg-transparent dark:border-gray-700">
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    id="email"
                    class="bg-transparent text-black border border-white rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-transparent dark:border-gray-600 dark:placeholder-gray-200 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div>
                  ...
                  <div className="border flex border-white text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600   dark:border-gray-600 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <input
                      ...
                      placeholder="••••••••"
                      class="bg-transparent text-black block w-full p-2 dark:bg-transparent dark:placeholder-gray-400 dark:text-black"
                      required=""
                    />
                    <div
                      className="p-2 mt-1"
                  ...
                  <div class="flex items-start">
                    <div class="flex items-center h-5">
                      <input
                        ...
                        type="checkbox"
                        class="w-4 h-4 border text-balck border-gray-300 bg-transparent rounded focus:ring-3 focus:ring-primary-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-primary-600 dark:ring-offset-gray-800"
                        required=""
                      />
                    </div>
                ...
                <p class="text-sm font-light text-black dark:text-black">
                  ...
                  <a
                    href="/signup"
                    class="font-medium text-black hover:underline dark:text-gray-300"
                  >
                    Sign up
                  </a>
                </p>

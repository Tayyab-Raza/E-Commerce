...
const Card2 = () => {
  ...
  const NextArrow = ({ onClick }) => {
    return (
      <div
        className="absolute top-1/2 transform -translate-y-1/2 right-0 z-10 cursor-pointer text-black"
        onClick={onClick}
      >
  ...
  const PrevArrow = ({ onClick }) => {
    return (
      <div
        className="absolute top-1/2 transform -translate-y-1/2 left-0 z-10 cursor-pointer text-black"
        onClick={onClick}
      >
        <FaArrowLeft size={20} />
      </div>
    ...
    <div className="relative mx-auto max-w-7xl">
      <Slider {...settings}>
        {products.map((product) => (
          ...
          >
            <div className="border p-2 rounded-md shadow hover:shadow-lg transition">
              {product.hot && (
